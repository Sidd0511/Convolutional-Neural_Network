...
classifier.add(Dense(units=64, kernel_regularizer=l2(0.01), bias_regularizer=l2(0.01), activation='relu'))
#classifier.add(Dropout(rate=0.1))

classifier.add(Dense(units=32,  kernel_regularizer=l2(0.01), bias_regularizer=l2(0.01), activation='relu'))
classifier.add(Dropout(rate=0.1))
